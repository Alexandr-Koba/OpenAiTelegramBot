...
def _translate(text: str):
    """Translates the text to Russian"""
...
async def start(update: Update, context: ContextTypes):
    ...
    button = [[KeyboardButton(text="Генерация по тексту")], [KeyboardButton(text="Генерация изображения")]]
...
if __name__ == '__main__':
    ...
    application = Application.builder().token("6195756066:AAE89ww9ym_qc96FhVWdDtZZw4sAa9TV5s0").read_timeout(100).get_updates_read_timeout(100).build()
